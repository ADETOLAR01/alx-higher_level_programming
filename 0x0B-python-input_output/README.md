...
This project gave me a chance to practice my Python file-handling skills. 
I used the 'with,' 'open,' and'read' methods in combination with 
the 'json' module to read and 
write files, serialize and deserialize objects, and do other JSON-related tasks.
...
| `1-write_file.py` | `def write_file(filename=""):` |
| `2-append_write.py` | `def append_write(filename="", nb_lines=0):` |
| `3-to_json_string.py` | `def to_json_string(filename="", text=""):` |
| `4-from_json_string.py` | `def from_json_string(filename="", text=""):` |
| `5-save_to_json_file.py` | `def save_to_json_file(my_obj):` | `6-load_from_json_file.py` | `def load_from_json_file(filename):` |
| `7-add_item.py` | `def add_item(my_obj, filename):` |
| `8-class_to_json.py` | `def class_to_json(filename):` |
| `9-student.py` | `def student(obj):` |
