...
The concept of inheritance in Python is the focus of this work. 
Through the process of defining classes that inherit from numerous base classes and 
then overriding their inherited methods and properties, 
I gained a better understanding of the relationship between super- and sub-classes.
